...
// 第三轮线索配置
export const thirdRoundConfig = {
  id: 'third-round',
  title: '第三轮线索查看器',
  mainImage: '/clues/third-round/第三轮线索集合.jpg',
  mainImageAlt: '第三轮线索集合',
  basePath: '/clues/third-round/',
  clueImages: [
    { id: 1, title: '第三轮线索 1', filename: '1大楼.jpg' },
    { id: 2, title: '第三轮线索 2', filename: '2大楼.jpg' },
    { id: 3, title: '第三轮线索 3', filename: '3大楼.jpg' },
    { id: 4, title: '第三轮线索 4', filename: '4大楼.jpg' },
    { id: 5, title: '第三轮线索 5', filename: '5大楼.jpg' },
    { id: 6, title: '第三轮线索 6', filename: '6大楼.jpg' },
    { id: 7, title: '第三轮线索 7', filename: '7任鸿辉办公室.jpg' },
    { id: 8, title: '第三轮线索 8', filename: '8任鸿辉办公室.jpg' },
    { id: 9, title: '第三轮线索 9', filename: '9任鸿辉办公室.jpg' },
    { id: 10, title: '第三轮线索 10', filename: '10任鸿辉办公室.jpg' },
    { id: 11, title: '第三轮线索 11', filename: '11任鸿辉办公室.jpg' },
    { id: 12, title: '第三轮线索 12', filename: '12休息室.jpg' },
    { id: 13, title: '第三轮线索 13', filename: '13休息室.jpg' },
    { id: 14, title: '第三轮线索 14', filename: '14休息室.jpg' },
    { id: 15, title: '第三轮线索 15', filename: '15休息室.jpg' },
    { id: 16, title: '第三轮线索 16', filename: '16休息室.jpg' }
  ],
  hotspots: [
    { id: 1, x: 2.5, y: 4, width: 9, height: 45 },
    { id: 2, x: 2.5, y: 52, width: 9, height: 45 },
    { id: 3, x: 12.5, y: 4, width: 9, height: 45 },
    { id: 4, x: 12.5, y: 52, width: 9, height: 45 },
    { id: 5, x: 22.5, y: 4, width: 9, height: 45 },
    { id: 6, x: 22.5, y: 52, width: 9, height: 45 },
    { id: 7, x: 38, y: 4, width: 9, height: 45 },
    { id: 8, x: 38, y: 52, width: 9, height: 45 },
    { id: 9, x: 48, y: 4, width: 9, height: 45 },
    { id: 10, x: 48, y: 52, width: 9, height: 45 },
    { id: 11, x: 58, y: 4, width: 9, height: 45 },
    { id: 12, x: 71, y: 4, width: 9, height: 45 },
    { id: 13, x: 71, y: 52, width: 9, height: 45 },
    { id: 14, x: 81, y: 4, width: 9, height: 45 },
    { id: 15, x: 81, y: 52, width: 9, height: 45 },
    { id: 16, x: 91, y: 4, width: 9, height: 45 }
  ]
};
...
export const menuItems = [
  ...
  },
  {
    id: 'third-round',
    title: '第三轮线索',
    description: '查看第三轮线索集合',
    config: thirdRoundConfig
  },
  {
    id: 'personal-clues',
    title: '个人线索',
